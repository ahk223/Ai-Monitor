                ...
                <div className="relative">
                    ...
                    {showQuickAdd && (
                        <>
                            ...
                            />
                            <div className="absolute left-0 top-full mt-2 z-50 w-56 rounded-xl border border-slate-200 bg-white p-2 shadow-xl dark:border-slate-700 dark:bg-slate-900">
                                <Link
